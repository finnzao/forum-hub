        ...
        <div className="border-2 border-slate-200 p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Código enviado para seu email</p>
            </div>
          </div>
          {erro && (
  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="border-2 border-slate-200 p-8">
        ...
        <p className="mt-4 text-xs text-slate-400 text-center">Suas credenciais são enviadas diretamente ao PJE e não são armazenadas.</p>
      </div>
    </div>
  );
}
